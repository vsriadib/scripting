...
#print(ssl_valid_time_remaining("exchange.easycareonline.com"))
print(ssl_valid_time_remaining("ws.apria.com"))
#print(ssl_valid_time_remaining("wst.apria.com"))
#print(ssl_valid_time_remaining("api.umbian.com"))